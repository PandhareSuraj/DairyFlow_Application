...
data class DeliveryRow(
    ...
    @SerialName("delivery_boy_status") val deliveryBoyStatus: String? = null,
    @SerialName("payment_status") val paymentStatus: String = "Unpaid",
    @SerialName("skip_reason") val skipReason: String? = null,
    @SerialName("delivery_boy_skip_reason") val deliveryBoySkipReason: String? = null,
    @SerialName("delivery_completed_at") val deliveryCompletedAt: String? = null,
    val notes: String? = null,
    @SerialName("created_at") val createdAt: String? = null,
    @SerialName("updated_at") val updatedAt: String? = null
)
